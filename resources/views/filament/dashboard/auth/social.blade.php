...
<div class="mt-4">
    ...
    <div class="flex gap-2">
        <a href="{{ route('social.redirect', 'google') }}" class="flex h-[2.4rem] flex-1 items-center justify-center gap-2 rounded-md border border-white/30 bg-white/20 transition-colors duration-150 hover:border-secondary-300 hover:bg-white/30 [&_svg]:block" aria-label="Doorgaan met Google">
