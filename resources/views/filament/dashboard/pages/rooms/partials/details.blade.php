<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded-[1.25rem] border border-[#0f17201f] p-6">
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-base font-medium tracking-[-0.01em] text-[#0f1720]">Kenmerken</h2>
        ...
        <dl class="space-y-4">
            @if ($room->surface_m2)
                <div class="flex items-center justify-between">
                    <dt class="flex items-center gap-2 text-sm text-[#586573]">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3.75v4.5m0-4.5h4.5m-4.5 0L9 9M3.75 20.25v-4.5m0 4.5h4.5m-4.5 0L9 15M20.25 3.75h-4.5m4.5 0v4.5m0-4.5L15 9m5.25 11.25h-4.5m4.5 0v-4.5m0 4.5L15 15" />
                        </svg>
                        Oppervlakte
                    </dt>
                    <dd class="text-sm font-medium text-[#0f1720]">{{ $room->surface_m2 }} m²</dd>
                </div>
            @endif
            <div class="flex items-center justify-between">
                <dt class="flex items-center gap-2 text-sm text-[#586573]">
                ...
                <dd class="text-sm font-medium text-[#0f1720]">
                    ...
                    @else
                        <span class="text-[#9aa6b4]">Nee</span>
                    @endif
                </dd>
            </div>
            <div class="flex items-center justify-between">
